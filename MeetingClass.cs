...
namespace Driving_School
{
    internal class MeetingClass
    {
        ...
        {
            MySqlCommand command = new MySqlCommand("UPDATE `sedinte` SET `Sedinta_ID`='@id','Instructor'=''@ii','Numar_inmatriculare'='@ni',`Tip_sedinta`='@ty',`Data`='@da',`Ora`='@hr',`Progres`='@pr',`Locatie`='@lo' WHERE Sedinta_ID=@id", connect.getconnection);
